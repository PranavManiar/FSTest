		...
		<div class="col-md-12 column">
			...
			<div class="row clearfix">
				<div class="col-md-9 column">
					...
					<div class="modal fade" id="modal-container-99092" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<div class="col-md-3 column">
					 <a href="#" class="btn btn-primary btn-default" type="button">Button</a>
				</div>
			</div>
				...
				<div class="col-md-10 column">
					...
					<div class="row clearfix">
						<div class="col-md-12 column">
							<div class="row clearfix">
								<div class="col-md-3 column">
									 <a href="#" class="btn" type="button">Button</a> <a href="#" class="btn" type="button">Button</a>
								</div>
								<div class="col-md-3 column">
									 <a href="#" class="btn" type="button">Button</a>
								</div>
